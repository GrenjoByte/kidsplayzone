	...
	<main>
		...
		<form class="ui form" enctype="multipart/form-data" id="registration_form">
			<div class="ui padded grid centered">
				<div class="twelve wide mobile twelve wide tablet six wide computer column">
					...
					<div class="ui basic segments">
						<div class="ui padded basic segment">
							...
							<div class="fields centered">
								<div class="eight wide field center aligned">
									<div class="ui left action input mini fluid">
										<div class="ui animated button basic mini" tabindex="-1">
						...
						<div class="ui padded segment">
							...
							<div class="field centered">
						    	...
						    	<div class="ui checkbox">
						      		...
						      		<label>Same as my Complete Address</label>
						    	</div>
						  	</div>
							<div class="fields">
								<div class="eight wide field">
						...
						<div class="ui padded segment center">
						  	...
						  	<div class="fields">
							  	...
							  	<div class="eight wide field">
									<div class="ui left action input mini fluid">
										...
										<input type="text" value="" placeholder="Verify Username" name="verify_username" id="verify_username">
									</div>
							  	</div>	
						  	</div>
						  	<br>
						  	<div class="fields">
							  	...
							  	<div class="eight wide field">
									<div class="ui left action input mini fluid">
										...
										<input type="password" value="" placeholder="Verify Password" name="verify_password" id="verify_password">
									</div>
							  	</div>
						  	</div>
						</div>
					...
					<div class="ui basic segment right aligned">
						<div class="field right">
					    	<div class="ui checkbox">
					      		<input type="checkbox" name="terms_agree" id="terms_agree" index="0" class="">
...
<script type="text/javascript">
	...
	$('#gender_drop')
	  	.dropdown()
	;
	$('#employment_type_drop')
	  	.dropdown()
	;
	$('#purok_street').on('input', function() {
		if ($('#same_address_check').is(':checked')) {
			$('#ec_purok_street').val($('#purok_street').val()).trigger('input');
		}
	});
	$('#barangay').on('input', function() {
		if ($('#same_address_check').is(':checked')) {
			$('#ec_barangay').val($('#barangay').val()).trigger('input');
		}
	});
	$('#city_municipality').on('input', function() {
		if ($('#same_address_check').is(':checked')) {
			$('#ec_city_municipality').val($('#city_municipality').val()).trigger('input');
		}
	});
	$('#province').on('input', function() {
		if ($('#same_address_check').is(':checked')) {
			$('#ec_province').val($('#province').val()).trigger('input');
		}
	});
	$('#zip_code').on('input', function() {
		if ($('#same_address_check').is(':checked')) {
			$('#ec_zip_code').val($('#zip_code').val()).trigger('input');
		}
	});
	$('#same_address_check').on('change', function() {
		...
		if (copy_check) {
			...
			$('#ec_purok_street').attr('readonly', '');
			$('#ec_barangay').attr('readonly', '');
			$('#ec_city_municipality').attr('readonly', '');
			$('#ec_province').attr('readonly', '');
			$('#ec_zip_code').attr('readonly', '');
		}
		else {
			$('#ec_purok_street').removeAttr('readonly');
			$('#ec_barangay').removeAttr('readonly');
			$('#ec_city_municipality').removeAttr('readonly');
			$('#ec_province').removeAttr('readonly');
			$('#ec_zip_code').removeAttr('readonly');
		}
	})
	...
	$('#registration_form')
     	...
     	onSuccess: function(event) {
				...
				if($('#registration_form').form('is valid') && terms_agree) {
					var ajax = $.ajax({
						method: 'POST',
						url   : '<?php echo base_url();?>i.php/sys_control/save_new_registration',
					...
					icon = 'close red';
			  		header = 'Must agree to the Terms and Conditions';
				  	message = 'Registrant must agree to the Terms and Conditions in order to proceed.';
				  	duration = 25000;
				  	load_notification(icon, header, message, duration);	
				}
	        },
	    	fields: {
	      		...
	      		employment_type: {
			        ...
			        rules: [
			          	{
			            	type   : 'empty',
			            	prompt : 'Please select your Employment Type.'
			          	}
			        ]
	      		},
	      		position: {
	      		...
	      		ec_name: {
			        ...
			        rules: [
			          	{
			            	type   : 'empty',
			            	prompt : 'Please enter your contact\'s Full Name.'
			          	}
			        ]
	      		},
	      		ec_relationship: {
	      		...
	      		ec_phone_number: {
			        ...
			        rules: [
			          	{
			            	type   : 'empty',
			            	prompt : 'Please enter your contact\'s Phone Number.'
			          	}
			        ]
	      		},
	      		ec_purok_street: {
			        ...
			        rules: [
			          	{
			            	type   : 'empty',
			            	prompt : 'Please enter your contact\'s Purok/Street.'
			          	}
			        ]
	      		},
	      		ec_barangay: {
			        ...
			        rules: [
			          	{
			            	type   : 'empty',
			            	prompt : 'Please enter your contact\'s Barangay.'
			          	}
			        ]
	      		},
	      		ec_city_municipality: {
			        ...
			        rules: [
			          	{
			            	type   : 'empty',
			            	prompt : 'Please enter your contact\'s City/Municipality.'
			          	}
			        ]
	      		},
	      		ec_province: {
			        ...
			        rules: [
			          	{
			            	type   : 'empty',
			            	prompt : 'Please enter your contact\'s Province.'
			          	}
			        ]
	      		},
	      		ec_zip_code: {
			        ...
			        rules: [
			          	{
			            	type   : 'empty',
			            	prompt : 'Please enter your contact\'s ZIP Code.'
			          	}
			        ]
	      		},
	      		email_address: {
